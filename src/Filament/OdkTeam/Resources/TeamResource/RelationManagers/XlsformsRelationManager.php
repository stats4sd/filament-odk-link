...
namespace Stats4sd\FilamentOdkLink\Filament\OdkTeam\Resources\TeamResource\RelationManagers;
            ...
            ->schema([
                ...
                Forms\Components\TextInput::make('title')
                    ...
                    ->unique(ignoreRecord: true, modifyRuleUsing: function (Unique $rule, self $livewire) {
                        return $rule->where('owner_id', $livewire->getOwnerRecord()->getKey())->where('owner_type', get_class($livewire->getOwnerRecord()));
                    }),
